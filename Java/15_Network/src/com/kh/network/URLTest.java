...
public void method2() {
	...
	try {	
			URL url = new URL("http://iei.or.kr");
...
/*
 * TCP/IP 4계층 - 네트워크(OSI) 7계층
 * 4계층 - 애플리케이션 계층           7계층 : 응용 계층 - 프로토콜(HTTP, FTP, SMTP,POP3...)
 *                              6계층 : 표현 계층 - 파일 인코딩(JPG, MPEG)
 *                              5계층 : 세션 계층 - API,Socket
 * 3계층 - 전송계층                 4계층 : 전송 계층 - TCP/UDP,PORT 번호
 * 2계층 - 인터넷계층                3계층 : 네트워크 계층 - IP,패킷(PacKet)
 * 1계층 - 링크계층                 2계층 : 데이터링크 계층 - 이더넷(MAC 주소)
 *                              1계층 : 물리 계층 - 케이블 
 * 
 * */
