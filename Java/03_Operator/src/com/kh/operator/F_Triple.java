...
public class F_Triple {
	 ...
	 * 삼항 연산자 조건식 ? 값1 : 값2;
	 * 
	 * - 조건식에는 주로 비교,논리 연산자가 사용된다. - 조건식의 결과가 true이면 식1을 수행한다. - 조건식의 결과가 false 이면
	 * 식2를 수행한다.
	 */
	...
	/*
	 * 실습 문제 1 사용자한테 두 개의 정수값을 입력받아서 두 정수의 곱셈 결과 100 보다 크거나 같은경우 "결과가 100 이상입니다."
	 ...
	 * 실습문제3
	 * 
	 * 두 정수를 입력받고 + 또는 - 를 입력받아서 계산을 출력 단,
	 *  +또는 - 이외의 문자를 입력하는 경우 "잘못 입력했습니다." 출력
	 * 
	 * 예시) 첫 번째 수 > 3 두 번째 수 > 4 연산자 입력(+ 또는 -) > + 3 + 4 = 7 연산자 입력(+ 또는 -) > - 3 -
	 * 4 = -1
	 * 
	 * * 연산자 입력(+ 또는 -) > * 잘못 입력했습니다.
	 */
