...
public class B_InDecrease {
	 ...
	 * - ++ : 값 1 증가 
	 * - -- : 값 1 감소
	 * - (증가연산자)값 : 전위 연산으로 먼저 증감 연산을 수행하고 다른 연산을 수행 
	 * - 값(증감연산자) : 후위 연산으로 먼저 다른 연산을 수행하고 증감 연삼을 수행
	 * */
	...
	public void method() {
		...
		System.out.println("전위 연산자 적용후 :" +number);// 12
		
		// 후위 연산자 테스트
		System.out.println("1회 수행 후 값 : " + number++); // 12
		System.out.println("2회 수행 후 값 :" + number++); // 13
		System.out.println("후위 연산자 적용후 :" + number); // 14
	}
