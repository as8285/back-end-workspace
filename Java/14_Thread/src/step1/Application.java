 ...
 * 	 코드를 모두 실행하거나 return문을 만나면 프로그램 실행이 종료 
 * - 메인 스레드는 필요에 의해 작업 스레드를 만들어서 병렬로 코드를 실행 할 수 있다 
 * 
 * * 멀티 스레드 
 * - 멀티 스레드는 하나의 프로세스 내에서 여러 스레드가 동시에 작업을 수행하는 것 
 * - 실행 중인 스레드가 하나라도 있다면 프로세스가 종료 되지 않는다.
...
public class Application {
	...
	public static void main(String[] args) {
		...
		ComeThread com = new ComeThread("ComeThread");
