...
public class A_If {
	...
	/*
	 * if문 if(조건식){ 조건식이 참(true)일 때 실행 } - 보통 조건식에는 비교연산자,논리연사자를 주로 사용
	 */
	public void method1() {
		...
		if (score >= 60)
			System.out.println("합격입니다"); // 한 줄만 들어 갔을 떄는 유용
	 ...
	 * 
	 * }else if(조건식2) { 조건식1이 거짓(false)이면서 조건식2이 참(true)일 때 실행
	 * 
	 * } else{ 조건식1,조건식2 모두 거짓(false)일 때 실행
	 *
	 * } - else if 수는 제한이 없다.
	 */

	/*
	 * 사용자에게 점수(0~100)를 입력받아서 점수별로 등급을 출력 -90점 이상은 A등급 -90점 미만 80점 이상은 B등급 -80점 미만
	 * 70점 이상은 C등급 -70점 미만 60점 이상은 D등급 -60점 미만 F등급
	 */

	public void practice1() {
		/*
		 * System.out.println("점수를 입력하세요 >"); int score
		 * =Integer.parseInt(sc.nextLine()); if (score >= 90) {
		 * System.out.println("A등급"); } else if (score >= 80 && score < 90) {
		 * System.out.println("B등급"); } else if (score >= 70 && score < 80) {
		 * System.out.println("C등급"); } else if (score >= 60 && score < 70) {
		 * System.out.println("D등급"); } else { System.out.println("F등급"); } }
		 */
	 ...
	 * 
	 * 
	 * if (num2 % 2==0) { System.out.println(num3); if (num3 % 2==0){
	 * System.out.println(num3); } } else { if (num3 % 2==0){
	 * System.out.println(num3); } } }else { if (num2 % 2==0){
	 * System.out.println(num2); } }
	 * 
	 */
// if ~ else if 사용! 중첩 X - > 비추천 !!! 
	 ...
	 * 
	 * }else if(num1 % 2 == 0 && num2 %2 != 0 && num3 % 2 == 0) {
	 * System.out.println(num1); System.out.println(num3);
	 * 
	 * } else if (num1 % 2 == 0 && num2 %2 != 0 && num3 % 2 != 0) {
	 * System.out.println(num1); } else if (num1 % 2 != 0 && num2 %2 == 0 && num3 %
	 * 2 == 0) System.out.println(num2); System.out.println(num3); } else if (num1 %
	 * 2 != 0 && num2 %2 != 0 && num3 % 2 == 0) { System.out.println(num3); } }
	 */
