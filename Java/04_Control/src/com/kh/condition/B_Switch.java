...
public class B_Switch {
	...
	/*	if(number==1)System.out.println("빨간색 입니다");
		else if(number==1)System.out.println("파란색 입니다");	
		else if(number==1)System.out.println("초록색 입니다");	
		...
		case 1 : System.out.println("빨간색 입니다");
			break;
		case 2 : System.out.println("파랑색 입니다");
			break;
