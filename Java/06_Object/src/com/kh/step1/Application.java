...
public class Application {
	 ...
	 * - 접근제한자는 public,default,private,protected
	 * - 클래스는 필드(Field),메서드(Method),생성자(Constructor)
	 * - 클래스 작성시 객체 지향 언어 특징 중
	...
	public static void main(String[] args) {
		...
		/*
		 * (Tv를 가져오기) import com.kh.step1.model.Tv;다른 패키지면 해줘야 한다.
		 * 객체 생성
		 * 
		 * 클래스명 변수명 = new 클래스명();
		 * - new 연산자를 사용해서 생성
		 * - new 연산자를 Heap 영역에 객체를 생성하고 객체의 주소값을 반환
		...
		System.out.println("TV 채널 : " + tv.channel); // tv 채널 0 
		tv.channelUp();
		tv.channelUp();
		tv.channelUp();
		tv.channelDown();
