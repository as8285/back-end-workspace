...
public class Calculator {
	 ...
	 * 
	 * 
	 * 리턴타입 메시드이름(타입 변수명,타입 변수명,...){ <-- 여기가 입력받는 곳 ! 
	 * 		// 메서드 호출시 수행될 코드
	 * 		return 결과값; <-- 출력하는곳! 
	 * } 
	 * 
 ...
 * - 반복문으로 바꿀수 있으며 때때로 반복문보다 성능이 나쁠 수도 있음 
 * - 이해하면 간결한 코드 작성이 가능 
 * */
	public int factorial2(int n) {
		
		int result = 1; 
		// if(조건) = n x (n-1) x (n-2)x ... 1
